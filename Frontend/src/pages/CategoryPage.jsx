              ...
              <div className="pt-4 space-y-5">
                <div className="flex space-x-5">
                  <button
                    ...
                    className={`flex-1 py-4 rounded-xl font-semibold text-lg transition-all ${isInCart(product._id)
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl border-2 text-center font-medium transition-all ${priceRange[1] <= 1000
                    ...
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl border-2 text-center font-medium transition-all ${priceRange[0] >= 1000 && priceRange[1] <= 5000
                          ? 'border-blue-500 bg-blue-50 text-blue-600'
                          : 'border-gray-200 hover:border-gray-300'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl border-2 text-center font-medium transition-all ${priceRange[0] >= 5000 && priceRange[1] <= 10000
                          ? 'border-blue-500 bg-blue-50 text-blue-600'
                          : 'border-gray-200 hover:border-gray-300'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`px-6 py-3 rounded-xl border-2 text-center font-medium transition-all ${priceRange[0] >= 10000
                          ? 'border-blue-500 bg-blue-50 text-blue-600'
                          : 'border-gray-200 hover:border-gray-300'
                        }`}
                    >
                  ...
                  >
                    ...
                    <div className="flex space-x-4">
                      <button
                        ...
                        className={`flex-1 py-3 rounded-xl font-medium transition-all text-lg ${isInCart(product._id)
                            ? 'bg-green-100 text-green-700'
                  ...
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-12 h-12 flex items-center justify-center rounded-xl font-medium transition-colors ${page === pageNum
